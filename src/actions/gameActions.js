...
export const fetchSecretWord = () => {
  return async (dispatch) => {
    dispatch(fetchSecretWordRequest()); // set loading to true and error to null in the store by dispatching the fetchSecretWordRequest action creator and the action that it returns to the store to update the state 
    try {
